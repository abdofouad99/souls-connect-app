        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className={cn("mb-12 transition-all duration-700", heroAnim.isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95")}>
              <img src={heroImage} alt="مشروع كفالة الأيتام - جمعية الأقصى" className="w-full max-w-3xl mx-auto rounded-2xl shadow-xl hover:shadow-2xl transition-shadow duration-300" />
            </div>

            {/* العنوان مع الزخرفة */}
            <div className={cn("mb-12 transition-all duration-700 delay-150", heroAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
              {/* خط زخرفي علوي */}
              ...
              {/* العنوان الرئيسي */}
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-foreground leading-relaxed">​العنوان: شارع جمال -جولة المسبح -مقابل الكريمي الرئيس-فوق محلات مرح-فوق عيادة د.سميرة الخليدي Taiz, Yemen  </h1>
            ...
            {/* قسم أرقام التواصل */}
            <div className={cn("bg-card rounded-2xl p-6 md:p-8 shadow-card max-w-md mx-auto transition-all duration-700 delay-300", heroAnim.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
