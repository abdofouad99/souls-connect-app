...
const Sponsorship = () => {
  ...
  return <Layout>
      <div className="min-h-screen bg-background">
        ...
        {/* Main Text Section */}
        <section ref={textAnimation.ref} className={`py-2 md:py-4 transition-all duration-700 delay-100 ${textAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="prose prose-lg text-foreground leading-loose space-y-6 text-right">
                ...
                <p className="text-lg md:text-xl">حين دلّك الله لتسير في درب الكافلين،
فهو اختيارٌ لك لتمسك بيد اليتيم،
فينجو في الدنيا، وتنجو أنت في الآخرة،
ولكليكما حتماً النجاة في الدنيا والآخرة…<br />
                  فهو اختيارٌ لك لتمسك بيد اليتيم،
                  <br />
                  فينجو في الدنيا، وتنجو أنت في الآخرة،
                  <br />
